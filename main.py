...
#contact
def contact():
    mess._show(title="Contact Me",message="7982968272")

#about
def about():
    mess._show(title="About",message="6TH SEM PROJECT BY PRIYANSHU PRIYA AYUSH")
...
trackImg = tkinter.Button(frame2, text="Take Attendance", command=takeattendence, fg="black", bg="#00aeff", height=1, activebackground = "white" ,font=('times', 16, ' bold '))
